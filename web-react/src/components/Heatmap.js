...
const steps = ["white", "#e7dfd5"]
const thresholds = scaleLinear().range(steps)

const colors = {
  "Ex Machina": "#204051",
  "Far from the Madding Crowd": "#3b6978",
  "The Longest Ride": "#84a9ac"
}
const frameProps = {   summaries: [{ coordinates: [{ theaterCount: 4, rank: 18, grossWeekly: 327616, title: "Ex Machina" },
  ...
  size: [350,200],
  margin: { left: 60, top: 60, bottom: 60, right: 1 },
  summaryType: "heatmap",
  xAccessor: "theaterCount",
  yAccessor: "rank",
  yExtent: [0],
  xExtent: [0],
  summaryStyle: function(e){return{fill:(e.percent),stroke:"#ccc",strokeWidth:.5}},
  pointStyle: d => {
    return {
      r: 2,
  ...
  title: (
    <text textAnchor="center">
      Theaters showing <tspan fill={"#204051"}>Ex Machina</tspan> vs{" "}
      <tspan fill={"#3b6978"}>Far from the Madding Crowd</tspan>
    </text>
  ),
